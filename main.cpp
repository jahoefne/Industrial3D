...
int main(int argc, char **argv) {
    ...
    //initialCloud->loadPointsFromFile("../data/bunny.xyz", 0, 0, 0);
...
*/
  ...
  //  app(argc, argv);
//    app.setOrganizationName("Industrial3D");
  //  app.setApplicationName("Industrial3D PointCloud Operations");

    QApplication app(argc, argv);
    MainWindow_ w;
    //QOpenGLWindow::w.resizeGL(1280, 720);
    w.show();
